...
(
    ...
    obp numeric(5,3) DEFAULT 0,
    slg numeric(5,3) DEFAULT 0,
...
(
    ...
    win_percentage numeric(4,3) NOT NULL DEFAULT 0,
    ...
    era_plus numeric(5,2) DEFAULT 0,
    fip numeric(5,2) DEFAULT 0,
    whip numeric(5,3) DEFAULT 0,
    hits_per_9 numeric(5,2) DEFAULT 0,
    bb_per_9 numeric(5,2) DEFAULT 0,
    k_per_9 numeric(5,2) DEFAULT 0,
...
(
    ...
    wild_pitches integer DEFAULT 0,
    batters_faced integer DEFAULT 0,
    era_plus numeric(7,2) DEFAULT 0,
...
(
    ...
    fielding_percentage numeric(4,3) DEFAULT 0,
